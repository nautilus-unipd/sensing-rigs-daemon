...
const char* ERR_RCVD_SIGTERM = "Received SIGTERM, terminating daemon";
const char* ERR_RCVD_SIGABRT = "Received SIGABRT, aborting daemon";
const char* ERR_INIT_SH = "Cannot initialize signal handlers";
