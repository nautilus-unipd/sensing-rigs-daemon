...
const char* restrict PHOTO_SHOOT_COMMAND = "rpicam-still -v 0 --zsl --width 1920 --height 1080 --camera %d -o %s%s%s%.2d%.2d%.2d.jpg";
...
const unsigned long int MIN_FREE_SPACE = 590000;
const uint32_t MAX_TEMP = 65000;
const uint8_t MAX_VOLT_BUFF_SIZE = 19;
const uint8_t MAX_COMMAND_SIZE = 125;
